...
Original file is located at
    https://colab.research.google.com/drive/1qcXp3l7WP8ggjs-i3iQwkRuGF1lrzUJr
"""
...
"""[import自定义类和方法](https://zhuanlan.zhihu.com/p/105647700)"""
import torch
import torch.nn as nn
#from  transformerEncoderbase import attention,encoder,feed_forward
...
class Transformer(nn.Module):
    ...
    #def forward(self, x1, x2, idx,  type="default"):
        ...
        elif datasetname=="valid":
            #print(idx)
            embedded_sents1 = return_emb1(idx,datasetname)
            embedded_sents2 = return_emb2(idx,datasetname)
            #print("embedded_sents1&embedded_sents2的类型")
            #print(type(embedded_sents1))
            #print(type(embedded_sents2))
            embedded_sents1 = torch.from_numpy(embedded_sents1).float()
            embedded_sents2 = torch.from_numpy(embedded_sents2).float()
